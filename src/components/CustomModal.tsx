...
const CustomModal = ({
  ...
  const [high, setHigh] = React.useState(selectedBet.high);
  const [p2Guess, setP2Guess] = React.useState(0);
  const [low, setLow] = React.useState(selectedBet.low);
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="text-[#ffffff]">
          Entrance fee: {selectedBet ? getSolAmount(selectedBet.amount) : ""}{" "}
          SOL
        </p>
      </div>
